...
/* Generated from ../O.Common/lakeshore625.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64", "asynAiFloat64Average", "devaiStream", "devAiStats",
    "devAiClusts", "devAoSoft", "devAoSoftRaw", "devAoSoftCallback",
    "asynAoInt32", "asynAoFloat64", "devaoStream", "devAoStats",
...
int lakeshore625_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/oksana/LAKESHORE_625/lakeshore625";
...
/* lakeshore625_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"lakeshore625_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    lakeshore625_registerRecordDeviceDriver(*iocshPpdbbase);
}
